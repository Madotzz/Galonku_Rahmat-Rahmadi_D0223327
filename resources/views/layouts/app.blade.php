            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <button class="dropdown-item" action="{{ route('profile.edit') }}">
                                    Profile
                                </button>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h5 mb-0 text-gray-800">Selamat Datang, <strong>{{ Auth::user()->name }}</strong>!</h1>
                    </div>
                    <div>
                        <h1 class="h5 mb-0 text-gray-800">Status sebagai: <strong>{{ Auth::user()->role ?? 'Guest' }}</strong></h1>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="{{ asset('sb-admin') }}/img/undraw_posting_photo.svg"
                                            alt="...">
                                    </div>
